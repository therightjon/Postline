...
export default function InstagramPreview({ content, mediaUrl }) {
  const displayContent = content || '';
  const isPlaceholder = !content;

  return (
    <div className="preview-card">
      <div className="preview-card-label" style={{ background: 'linear-gradient(135deg, #833AB4, #FD1D1D, #F77737)', color: 'white' }}>
      ...
      <div className="ig-post">
        ...
        <div className="ig-header">
          <div className="ig-avatar">P</div>
          <div>
            <div className="ig-username">postline</div>
          </div>
        ...
        <div className="ig-image-area">
          {mediaUrl ? (
            ...
            <div className="ig-image-placeholder">
              ...
              <span>Add an image for Instagram</span>
            </div>
          )}
        </div>
        ...
        <div className="ig-caption">
          <span className="ig-caption-user">postline</span>
          {isPlaceholder ? (
            <span className="ig-caption-placeholder">Write your caption...</span>
          ) : (
            displayContent
          )}
        </div>
